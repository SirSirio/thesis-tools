...
| [System Architecture Explorer](tools/system-architecture-explorer/index.html) | Control-electronics cost / complexity selector for the pump's driver and communications architecture. Sortable, filterable 19-variant matrix with editable BOM prices, a live DKK↔EUR converter, per-component source/confidence tags, a pins-used/free feasibility readout with overrun flags, and a live variant-driven SVG system diagram (click a row to redraw). English interface. | ✅ Live |

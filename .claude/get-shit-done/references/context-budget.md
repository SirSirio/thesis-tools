...
The keys live in `.claude/settings.json` (project) or `D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/settings.json` (global) — **not** in `.planning/config.json`:

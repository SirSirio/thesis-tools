...
Key references:
- @D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/get-shit-done/USER-PROFILE.md" "D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/CLAUDE.md
```

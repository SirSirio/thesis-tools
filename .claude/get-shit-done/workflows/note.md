...
- **Global scope**: `D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/notes/`)
...
2. Glob `D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/notes/*.md` (if directory exists) — global notes
...
Global (D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/notes/` — works in any directory

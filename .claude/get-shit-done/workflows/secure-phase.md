...
```
Agent(
  prompt="Read D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/get-shit-done/templates/SECURITY.md`

...
```markdown
Read D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/agents/gsd-ui-checker.md for instructions.

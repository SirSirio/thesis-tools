...
<required_reading>
@D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/get-shit-done/references/ai-frameworks.md
@D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/agents/gsd-eval-planner.md for instructions.

...
<!-- For checkpoint task examples and patterns, see @D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/get-shit-done/references/checkpoints.md -->
...
See `D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.

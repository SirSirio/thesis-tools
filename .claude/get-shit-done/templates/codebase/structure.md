...
- Usage: Reference from command with `@D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

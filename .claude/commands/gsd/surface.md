...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/.gsd-surface.json`
(sibling to `D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/skills`).
...
`D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/.gsd-surface.json`
Install profile marker: `D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/.gsd-profile`
Skill dirs: `D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/skills/gsd-*/`
Engine module: `D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `D:/03. DTU - Offline/03. MASTER THESIS/02. GitHub Thesis Tools Page/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>

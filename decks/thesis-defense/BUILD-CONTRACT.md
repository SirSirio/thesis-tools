...
- **Who you are, what you may edit, and how Sirio wants to be answered is `ASSISTANT-GUIDE.md`. Read it before anything else if you are running one of the per-part chats; it also carries the content rules, the verification owed and the traps that have cost whole rounds.**

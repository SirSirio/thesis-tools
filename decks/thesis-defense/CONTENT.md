...
- **Notes by step** (~20 s; step-synced, 2026-09-23; step 0 is arrival): (0) Each pump and its reagent share one printed holder. (1) The container is Marius's design; the holder is mine. (2) The pump drops in from above, the container from the front. (3) — (4) The left one also screws into the side wall. (5) They slot together and are screwed down. (6) —
...
- **2026-09-23, Sirio’s review:** the model panel’s kicker read **Model first**; it now states the finding, **The pump model was not tested** (Ch. 13, analytical models versus physical prototypes: “the model was never experimentally validated”). The note under the delivered value, “the model was never validated”, said the same thing and is deleted. In the notes, “I built mine four times” became **“I built the rotary peristaltic one four times”**: Sirio asked for “the peristaltic one”, but Marius’s linear pump is peristaltic too, so “rotary” keeps it unambiguous.
- **Notes by step** (~45 s; step-synced, 2026-09-23; step 0 is arrival): (0) A module can be developed in depth or in breadth. (1) Depth means building one idea many times, but you choose its shape before trying the others. (2) Breadth means building several ideas, but a quick build can fail for the build, not the idea. (3) The pump had both: Marius built a linear pump, I tested a syringe pump, and I built the rotary peristaltic one four times. (4) The alignment module had breadth only on paper: about fifty ideas, one built, though it sets the machine's size. (5) And the pump's model was never tested: it aimed at 5 µL per stroke, and both pumps deliver less. Unstepped: If asked: the two pumps deliver 3.94 and 4.10 µL per stroke. The rotary pump beat the linear one 3485 to 3185 in the scoring. With printing now held to ±0.10 mm, a real test series of rotors is worth running.
- IT: 6 captions, steps 0 to 5 (see CONTENT-IT.md).
...
- **S43.** (Recomposed 2026-09-23.) No QR spiral and no tools grid any more: two display words rise, “Thank you.” over the names and “Questions?” over the mark, each with its own rule. The rotor mark — the hold screen's own, stroked with its breathing halo — turns endlessly on the same 26 s clockwise animation as S00 rather than sweeping once and stopping, and keeps turning for the whole question session.

...
- Re-laid out 2026-09-24 with S28 (see there): pictures ×1.12 from top 178.
...
- **2026-09-24, one-line title:** the rule rises to 138 and the chart and right column move from top 200 to 190. They cannot grow: the row already spans the full 1168 px between the margins.
...
- **2026-09-24, one-line title:** the cards move from top 200 to 160 and grow into the freed height. The active cap card goes from 384 × 480 to 429 × 520 (photo box 380), the battery card from 600 × 480 to 620 × 491 (photo box 349), and the septum and idle cards from 384 to 424 tall (media 212 to 252). Each photo box keeps its picture's own ratio.
...
- **2026-09-24, one-line title:** the rule rises to 138. The tile row grows (the group tile from 260 × 190 to 260 × 264, the five tiles from 150 × 150 to 150 × 224), the wires and car follow the row centre, the chain is centred between the rule and the footer, and the note grows from 21 to 24 px.
...
- **2026-09-24, one-line title:** the rule rises to 138. The dispenser photo grows from 416 × 234 to 512 × 288 (16:9, contained), the reader panel becomes 528 × 288, and the handoff code, arrow, bus and rail cards are re-placed to match.

...
**S28. Interlocking carriers integrate pumps and storage.** *(retitled by Sirio 2026-09-24; was “Each pump and its reagent storage share one printed carrier, and the carriers hold each other.”)*
- **Re-laid out 2026-09-24 for the one-line title** (the whole record run, S28 to S30b): `--head-h` 0, so the rule sits at 138; the kicker moves from top 196 to 150; every picture moves from top 224 to 178 and grows ×1.12 about the slide centre (S30 ×1.10, the widest pair's limit), each box at its picture's own ratio, so the callouts and drawn overlays grow with it; the record bar along the bottom is unchanged, and the pictures fly into it from their new positions.
...
**S29. Rigid nozzle mounting and tilted display with pen holder.** *(retitled by Sirio 2026-09-24; was “The nozzle bolts to the chassis; the screen tilts to 45 degrees so you look down at it.”)*
- Re-laid out 2026-09-24 with S28 (see there): pictures ×1.12 from top 178. On review the closing pair became equal: both photos 557 × 314 (16:9, contained) at top 178, left edge on the kicker's margin (56 and 667), so the row spans the full width; the chips move with them.
...
**S30. On-board battery enables untethered operation.** *(retitled by Sirio 2026-09-24; was “A published battery holder and three screws put the power on board.”)*
- Re-laid out 2026-09-24 with S28 (see there): pictures ×1.10 from top 178.
...
**S30b. The fully assembled machine.** *(retitled by Sirio 2026-09-24; was “Four joints turn the modules into one object of 3.3 kilograms.”)* *(new, 2026-09-22)*
- Re-laid out 2026-09-24 with S28 (see there): the plate is now 557 × 314 at 56, 178, and the weight moved to 666, 269 to stay centred on it.
...
**S31. Accuracy and precision well within the requirements.** *(retitled by Sirio 2026-09-24; was “Calibrated on itself, the machine lands within 3.4 % of the target.”)*
- **2026-09-24, one-line title:** the rule rises to 138 and the chart and right column move from top 200 to 211, centred under the rule. They cannot grow: the row already spans the full 1168 px between the margins. The per-stroke note breaks deliberately, “about 10 % less / than on the bench”, so no word sits alone.
...
**S33. Three failure modes observed during testing.** *(retitled by Sirio 2026-09-24; was “The three failure modes were cap friction, battery depletion, and septum leakage.”)*
- **2026-09-24, one-line title, then reviewed:** every photo box now carries its picture's own ratio in every state, active or idle (cap 383 × 338 active, 254 × 224 idle; battery 600 × 337 active, 254 × 142 idle; the drawn septum 600 × 338 active, 254 × 224 idle, each the card's inner width over the picture's ratio), so no card is letterboxed. All three card tops align at y 160 under the rule; each card's media sits at the top at its own height with the text right under it, so only the bottoms differ, and the row stays inside y 160–638.
...
**S40. Roadmap for rebuilding the next prototype.** *(retitled by Sirio 2026-09-24; was “The next prototype starts from the modules, in the order their geometry depends.”)*
- **2026-09-24, one-line title, then reviewed:** the rule rises to 138. The tiles are as tall as their content (tile 01 260 × 180, tiles 02–06 150 × 112), the chain and the “Designed last…” note form one block centred between the rule and the footer, the wires and car follow the row centre, and tile 01 lists Pump, Storage, Nozzle on three deliberate lines.
...
**S41. From sample preparation to complete diagnostics.** *(retitled by Sirio 2026-09-24; was “A prepared sample is not an answer: pair the dispenser with a reader.”)*
- **2026-09-24, one-line title, then reviewed:** the rule rises to 138. The dispenser photo grows from 416 × 234 to 512 × 288 (16:9, contained), the reader panel becomes 528 × 288, and the handoff code, arrow, bus and rail cards are re-placed to match. The detector bay is a closed box sitting 20 px inside the reader's dashed edge, so the two outlines never meet; the bus riser leaves from the bay's bottom.

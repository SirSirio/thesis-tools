...
- **2026-09-24, one-line title, then reviewed:** every photo box now carries its picture's own ratio in every state, active or idle (cap 383 × 340 active, 254 × 225 idle; battery 600 × 338 active, 254 × 143 idle; the drawn septum 600 × 340 active, 254 × 225 idle), so no card is letterboxed. The cards hang from one shared text line: every card's foot starts at y 497, the media sits above it at its own height, and the tallest state is centred under the rule.

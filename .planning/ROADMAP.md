...
- [x] 08-01-PLAN.md — Engine + shell: tool page scaffold, input panel (liquids/flow params/concurrency slider/mode toggle/constants), and the benchmark-faithful simulateSchedule scheduling engine

**Wave 2** *(blocked on Wave 1 — same file)*

- [x] 08-02-PLAN.md — Outputs & visualization: four D-11 metric cards, row-per-station steady-state Gantt (bottleneck highlight, no scroll), illustrative rack-indexing animation
...
| 9. Pump Testing | 1/6 | In Progress|  |
